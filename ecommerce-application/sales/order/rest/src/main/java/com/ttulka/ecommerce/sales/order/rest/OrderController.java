...
class OrderController {
    ...
    @PostMapping("/incident/latency/on")
    @ResponseStatus(HttpStatus.OK)
    public void enableLatencyIncident() {
        faultInjection.enableLatency();
    }

    @PostMapping("/incident/latency/off")
    @ResponseStatus(HttpStatus.OK)
    public void disableLatencyIncident() {
        faultInjection.disableLatency();
    }
